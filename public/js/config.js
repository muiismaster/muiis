...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('mailbox.scheduledsms', {
            url: "/scheduledsms",
            templateUrl: "views/scheduledsms.html",
            data: { pageTitle: 'Scheduled sms' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
         ...
         .state('mailbox.smsapproval', {
            url: "/smsapproval",
            templateUrl: "views/smsapproval.html",
            data: { pageTitle: 'agronomy sms' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('mailbox.email_view', {
            ...
            data: { pageTitle: 'Send/Schedule Message' }
        })
        ...
        .state('farmers.profile_list', {
            url: "/profile_list",
            templateUrl: "views/farmers_profile_list.html",
            data: { pageTitle: 'Farmer Profile List' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('farmers.duplicate_profile_list', {
            url: "/duplicate_profile_list",
            templateUrl: "views/duplicate_profile_list.html",
            data: { pageTitle: 'Farmer Profile List' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('subscriptions.payment_summary', {
            url: "/payment_summary",
            templateUrl: "views/payment_summary.html",
            data: { pageTitle: 'Subscription Payment Summary' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('subscriptions.payment_history', {
            url: "/payment_history",
            templateUrl: "views/payment_history.html",
            data: { pageTitle: 'Farmer Payment History' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('subscriptions.unsubscribed_farmers', {
            url: "/unsubscribed_farmers",
            templateUrl: "views/unsubscribed_farmers.html",
            data: { pageTitle: 'Unsubscribed Farmers List' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
