...
/**
 * dashboardSubscriptionsPaymentsGraphCtril - 
 */
function dashboardSubscriptionsPaymentsGraphCtril() {
...
function datatablesCtrl($scope,DTOptionsBuilder, $http,API_URL){

    var http = $http;
    $scope.farmerProfiles ={};
    $scope.pagination ={};
    $scope.loadData = function(url){
    //retrive profiles
        console.log('retrive profiles'); 
            http.get(url)
                .success(function(response) {
                    $scope.farmerProfiles = response.data;
                    $scope.pagination = { 
                    ...
                    console.log( $scope.farmerProfiles);
                });
    }

    var url = API_URL + "farmers";
    $scope.loadData(url);   

    $scope.onclickloadData = function(page){   
    var url = API_URL + "farmers/" + page;
        console.log(url);
        $scope.loadData(url);   
    };
...
function unsubscribedFarmersCtrl($scope,DTOptionsBuilder, $http,API_URL){

    var http = $http;
    $scope.unsubscribedFarmers ={};
    $scope.pagination ={};
    $scope.loadData = function(url){
    //retrive profiles
        console.log('retrive unsubscribed Farmers'); 
            http.get(url)
                .success(function(response) {
                    $scope.unsubscribedFarmers = response.data;
                    $scope.pagination = { 
                        'total': response.total,
                        'current_page':  response.current_page,
                        'next_page_url': response.next_page_url,
                    ...
                    console.log( $scope.unsubscribedFarmers);
                });
    }

    var url = API_URL + "unsubscribed_farmers";
    $scope.loadData(url);   

    $scope.onclickloadData = function(page){   
    var url = API_URL + "unsubscribed_farmers/" + page;
        console.log(url);
        $scope.loadData(url);   
    };
...
function qualityChecksCtrl($scope,$http,API_URL){
    ...
    $scope.loadData = function(url){
    //retrive profiles
        console.log('retrive duplicate profiles'); 
            http.get(url)
                .success(function(response) {
                    $scope.farmerProfiles = response.data;
                    $scope.pagination = { 
    ...
    var url = API_URL + "duplicate_farmers";
    $scope.loadData(url);   

    $scope.onclickloadData = function(page){   
        var url = API_URL + "duplicate_farmers/" + page;
        console.log(url);
        $scope.loadData(url);   
    };
...
function paymentSummaryCtrl($scope,$http,API_URL){
    ...
    $scope.subscriptionSummary ={};
    $scope.pagination ={};
    $scope.loadData = function(url){
    //retrive payment summaries
        console.log('retrive payment summaries'); 
            http.get(url)
                .success(function(response) {
                    $scope.subscriptionSummary = response.data;
                    $scope.pagination = { 
                        'total': response.total,
                        'current_page':  response.current_page,
                        'next_page_url': response.next_page_url,
                    ...
                    console.log( $scope.subscriptionSummary);
                });
    }

    var url = API_URL + "subscriptions";
    $scope.loadData(url);   

    $scope.onclickloadData = function(startDate,endDate,page=1){  
        if(startDate=='' || startDate==undefined) {
             var url = API_URL + "subscriptions/" +  page;
        }else{
            var url = API_URL + "subscriptions/" + page +"/"+ startDate +"/"+ endDate  ;
        }        
...
function paymentHistoryCtrl($scope, $http,API_URL){  
    var http = $http;
    $scope.search ={
        phone:''
    };
    ...
    $scope.pagination ={};
    $scope.loadData = function(url){
    //retrive payment history
        console.log('retrive payment history'); 
            http.get(url)
                .success(function(response) {
    ...
    var url = API_URL + "payment_history";
    $scope.loadData(url);   

    $scope.onclickloadData = function(phone,page=1){  
        if(phone=='' || phone==undefined) {
             var url = API_URL + "payment_history/" +  page;
        }else{
            var url = API_URL + "payment_history/" + page +"/"+ phone ;
        }        
...
function dasboardTotalsCtrl($scope, $http,API_URL){  
    var http = $http;


    $scope.farmersSummary = {};


    $scope.loadFarmersSummary = function(url){
    //retrive payment history
        console.log('retrive  farmers Summary.....'); 
            http.get(url)
                .success(function(response) {
                   $scope.farmersSummary= response;
                });
    }

    var url = API_URL + "farmersSummary";
    $scope.loadFarmersSummary(url);   


    $scope.subscriptionSummary = {};
    $scope.loadSubscriptionSummary = function(url){
    //retrive payment history
        console.log('retrive  farmers Summary.....'); 
            http.get(url)
                .success(function(response) {
                   $scope.subscriptionSummary= response;
                });
    }

    var url = API_URL + "farmersSummary";
    $scope.loadSubscriptionSummary(url);   

    
    

    $scope.paymentsSummary = {
        title:'Payments',
        subtitle:'Total Insurance Payments Made',
        total: 15000000,
        currency: ' (UGX)'
    };
...
function outboxCtrl($scope,$http,API_URL){  
    ...
    $scope.loadData = function(url){
    //retrive outbox messages
        console.log('retrive outbox messages'); 
            http.get(url)
                .success(function(response) {
    ...
    var url = API_URL + "outbox";
    $scope.loadData(url);   

    $scope.onclickloadData = function(startDate,endDate,page=1){  
        if(startDate=='' || startDate==undefined) {
             var url = API_URL + "outbox/" +  page;
        }else{
            var url = API_URL + "outbox/" + page +"/"+ startDate +"/"+ endDate  ;
        }        
    ...
    $scope.save = function() {
        var url = API_URL + "send";
        console.log( $.param($scope.message));
        $http({
            method: 'POST',
            url: url,
    ...
    $scope.getRegions = function(url){
          console.log('retrive regions'); 
            http.get(url)
                .success(function(response) {
    ...
    $scope.getDistricts = function(url){
         console.log('retrive districts'); 
            http.get(url)
                .success(function(response) {
    ...
    $scope.getCrops = function(url){
         console.log('retrive crops'); 
            http.get(url)
                .success(function(response) {
     ...
     var url_regions = API_URL + "regions";
     $scope.getRegions(url_regions);
     
     var url_districts = API_URL + "districts";
     $scope.getDistricts(url_districts);

      var url_districts = API_URL + "crops";
     $scope.getCrops(url_districts);

}


function scheduledsmsCtrl($scope,$http,API_URL){     
    ...
    $scope.loadData = function(url){
    //retrive scheduled sms messages
        console.log('retrive scheduled sms messages'); 
            http.get(url)
                .success(function(response) {
                    $scope.scheduledsms = response.data;
                    $scope.pagination = { 
                        'total': response.total,
                        'current_page':  response.current_page,
                        'next_page_url': response.next_page_url,
                    ...
                    console.log( $scope.scheduledsms);
                });
    }

    var url = API_URL + "scheduledsms";
    $scope.loadData(url);   

    $scope.onclickloadData = function(startDate,endDate,page=1){  
        if(startDate=='' || startDate==undefined) {
             var url = API_URL + "scheduledsms/" +  page;
        }else{
            var url = API_URL + "scheduledsms/" + page +"/"+ startDate +"/"+ endDate  ;
        }        
...
angular
    ...
    .controller('qualityChecksCtrl', qualityChecksCtrl)
    .controller('paymentSummaryCtrl', paymentSummaryCtrl)
    .controller('outboxCtrl', outboxCtrl)
    .controller('dasboardTotalsCtrl', dasboardTotalsCtrl)
    .controller('unsubscribedFarmersCtrl', unsubscribedFarmersCtrl)  
    .controller('scheduledsmsCtrl', scheduledsmsCtrl)  
      
    .controller('dashboardSubscriptionsPaymentsGraphCtril', dashboardSubscriptionsPaymentsGraphCtril);
